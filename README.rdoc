...
* Bugfix: Prevent to load default template in case updated issue form triggered by states change event.
** (Related: bitbucket#36, Template loads every time Status is changed.)
