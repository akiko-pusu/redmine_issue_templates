...
Rails.application.routes.draw do
  ...
  match 'global_issue_templates/:action', controller: 'global_issue_templates', via: %i[get post]
  match 'global_issue_templates/:action/:id', to: 'global_issue_templates#edit', via: %i[patch put post get], as: 'global_issue_template'
